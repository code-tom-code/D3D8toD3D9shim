...
struct IDirect3DVertexBuffer8Hook : public IDirect3DVertexBuffer8
{
public:
	IDirect3DVertexBuffer8Hook(LPDIRECT3DVERTEXBUFFER9 _realObject, IDirect3DDevice8Hook* _parentDevice) : realObject(_realObject), parentDevice(_parentDevice), refCount(1)
	{
	}
	...
	virtual ~IDirect3DVertexBuffer8Hook()
	{
		ObjDestroy(this);
	}
