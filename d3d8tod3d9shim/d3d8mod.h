// This is a *modified* version of a real Microsoft d3d8.h header file.
// This means that the definitions and declarations found in here are *not* exactly the same
// as in a real d3d8.h and this may cause incompatabilities if you try and use this in your
// programs as if it were a real d3d8.h file!

// The original version of this d3d8.h was copied from the August 2007 DXSDK.
...
#ifndef DIRECT3D_VERSION8
#define DIRECT3D_VERSION8         0x0800
#endif  //DIRECT3D_VERSION8

// include this file content only if compiling for DX8 interfaces
#if(DIRECT3D_VERSION8 >= 0x0800)
...
#include "d3d8typesmod.h" // Use the modded d3d8types.h
#include "d3d8capsmod.h" // Use a very slightly modded d3d8caps.h
...
DECLARE_INTERFACE_(IDirect3D8, IUnknown)
{
    ...
    STDMETHOD(CheckDeviceType)(THIS_ UINT Adapter,D3DDEVTYPE CheckType,d3d8::D3DFORMAT DisplayFormat,d3d8::D3DFORMAT BackBufferFormat,BOOL Windowed) PURE;
    STDMETHOD(CheckDeviceFormat)(THIS_ UINT Adapter,D3DDEVTYPE DeviceType,d3d8::D3DFORMAT AdapterFormat,DWORD Usage,D3DRESOURCETYPE RType,d3d8::D3DFORMAT CheckFormat) PURE;
    STDMETHOD(CheckDeviceMultiSampleType)(THIS_ UINT Adapter,D3DDEVTYPE DeviceType,d3d8::D3DFORMAT SurfaceFormat,BOOL Windowed,d3d8::D3DMULTISAMPLE_TYPE MultiSampleType) PURE;
    STDMETHOD(CheckDepthStencilMatch)(THIS_ UINT Adapter,D3DDEVTYPE DeviceType,d3d8::D3DFORMAT AdapterFormat,d3d8::D3DFORMAT RenderTargetFormat,d3d8::D3DFORMAT DepthStencilFormat) PURE;
    STDMETHOD(GetDeviceCaps)(THIS_ UINT Adapter,D3DDEVTYPE DeviceType,D3DCAPS8* pCaps) PURE;
    STDMETHOD_(HMONITOR, GetAdapterMonitor)(THIS_ UINT Adapter) PURE;
    STDMETHOD(CreateDevice)(THIS_ UINT Adapter,D3DDEVTYPE DeviceType,HWND hFocusWindow,DWORD BehaviorFlags,d3d8::D3DPRESENT_PARAMETERS* pPresentationParameters,IDirect3DDevice8** ppReturnedDeviceInterface) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DDevice8, IUnknown)
{
    ...
    STDMETHOD(CreateAdditionalSwapChain)(THIS_ d3d8::D3DPRESENT_PARAMETERS* pPresentationParameters,IDirect3DSwapChain8** pSwapChain) PURE;
    STDMETHOD(Reset)(THIS_ d3d8::D3DPRESENT_PARAMETERS* pPresentationParameters) PURE;
    ...
    STDMETHOD(CreateTexture)(THIS_ UINT Width,UINT Height,UINT Levels,DWORD Usage,d3d8::D3DFORMAT Format,D3DPOOL Pool,IDirect3DTexture8** ppTexture) PURE;
    STDMETHOD(CreateVolumeTexture)(THIS_ UINT Width,UINT Height,UINT Depth,UINT Levels,DWORD Usage,d3d8::D3DFORMAT Format,D3DPOOL Pool,IDirect3DVolumeTexture8** ppVolumeTexture) PURE;
    STDMETHOD(CreateCubeTexture)(THIS_ UINT EdgeLength,UINT Levels,DWORD Usage,d3d8::D3DFORMAT Format,D3DPOOL Pool,IDirect3DCubeTexture8** ppCubeTexture) PURE;
    ...
    STDMETHOD(CreateIndexBuffer)(THIS_ UINT Length,DWORD Usage,d3d8::D3DFORMAT Format,D3DPOOL Pool,IDirect3DIndexBuffer8** ppIndexBuffer) PURE;
    STDMETHOD(CreateRenderTarget)(THIS_ UINT Width,UINT Height,d3d8::D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,BOOL Lockable,IDirect3DSurface8** ppSurface) PURE;
    STDMETHOD(CreateDepthStencilSurface)(THIS_ UINT Width,UINT Height,d3d8::D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,IDirect3DSurface8** ppSurface) PURE;
    STDMETHOD(CreateImageSurface)(THIS_ UINT Width,UINT Height,d3d8::D3DFORMAT Format,IDirect3DSurface8** ppSurface) PURE;
    ...
    STDMETHOD(SetRenderState)(THIS_ d3d8::D3DRENDERSTATETYPE State,DWORD Value) PURE;
    STDMETHOD(GetRenderState)(THIS_ d3d8::D3DRENDERSTATETYPE State,DWORD* pValue) PURE;
    ...
    STDMETHOD(GetTextureStageState)(THIS_ DWORD Stage,d3d8::D3DTEXTURESTAGESTATETYPE Type,DWORD* pValue) PURE;
    STDMETHOD(SetTextureStageState)(THIS_ DWORD Stage,d3d8::D3DTEXTURESTAGESTATETYPE Type,DWORD Value) PURE;
...
DECLARE_INTERFACE_(IDirect3DTexture8, IDirect3DBaseTexture8)
{
    ...
    STDMETHOD_(DWORD, GetLOD)(THIS) PURE;
    STDMETHOD_(DWORD, GetLevelCount)(THIS) PURE;
    STDMETHOD(GetLevelDesc)(THIS_ UINT Level,d3d8::D3DSURFACE_DESC *pDesc) PURE;
...
DECLARE_INTERFACE_(IDirect3DVolumeTexture8, IDirect3DBaseTexture8)
{
    ...
    STDMETHOD_(DWORD, GetLOD)(THIS) PURE;
    STDMETHOD_(DWORD, GetLevelCount)(THIS) PURE;
    STDMETHOD(GetLevelDesc)(THIS_ UINT Level,d3d8::D3DVOLUME_DESC *pDesc) PURE;
...
DECLARE_INTERFACE_(IDirect3DSurface8, IUnknown)
{
    ...
    STDMETHOD(GetDesc)(THIS_ d3d8::D3DSURFACE_DESC *pDesc) PURE;
...
DECLARE_INTERFACE_(IDirect3DVolume8, IUnknown)
{
    ...
    STDMETHOD(FreePrivateData)(THIS_ REFGUID refguid) PURE;
    STDMETHOD(GetContainer)(THIS_ REFIID riid,void** ppContainer) PURE;
    STDMETHOD(GetDesc)(THIS_ d3d8::D3DVOLUME_DESC *pDesc) PURE;
...
#endif /* (DIRECT3D_VERSION8 >= 0x0800) */
#endif /* _D3D_H_ */
