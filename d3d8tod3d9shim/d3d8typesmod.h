// This is a *modified* version of a real Microsoft d3d8types.h header file.
// This means that the definitions and declarations found in here are *not* exactly the same
// as in a real d3d8types.h and this may cause incompatabilities if you try and use this in your
// programs as if it were a real d3d8types.h file!

// The original version of this d3d8types.h was copied from the Windows 8.1 SDK.
...
// The new d3d8 namespace
namespace d3d8 {


typedef enum _D3DLIGHTTYPE8 {
    D3DLIGHT_POINT          = 1,
    D3DLIGHT_SPOT           = 2,
...
typedef struct _D3DLIGHT8 {
    d3d8::D3DLIGHTTYPE8    Type;            /* Type of light source */
...
#define D3DFVF_POSITION_MASK8   0x00E
...
#define D3DFVF_RESERVED28        0xE000  // 4 reserved bits
...
//
#define D3DSP_REGNUM_MASK8       0x00001FFF
...
#ifndef D3DDEVINFOID_ZERO
	#define D3DDEVINFOID_ZERO 0
#endif
